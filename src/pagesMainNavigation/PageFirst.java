...
import pagesMainFeatures.PageAdminSetup;

/*
 * PageFirst class represents the initial screen for the first user.
...
public class PageFirst {
	...
	public PageFirst(DatabaseHelper databaseHelper) {
    ...
    public void show(Stage primaryStage) {
	    ...
	    continueButton.setOnAction(a -> {
	        new PageAdminSetup(databaseHelper).show(primaryStage);
